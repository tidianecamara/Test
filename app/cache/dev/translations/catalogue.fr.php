...
',
  ...
  'Admingenerator' => 
  array (
    'double_list.selected' => 'Sélectionné',
    'double_list.unselected' => 'Non-sélectionné',
    'date_range.from.label' => 'Du',
    'date_range.to.label' => 'Au',
    'boolean.yes' => 'Oui',
    'boolean.no' => 'Non',
    'boolean.yes_or_no' => 'Oui ou Non',
    'pagerfanta.previous' => 'Précédent',
    'pagerfanta.next' => 'Suivant',
    'list.no.results' => 'Il n\'y a pas de résultats.',
    'list.filters' => 'Filtres',
    'list.button.filter' => 'Filtrer',
    'list.button.reset' => 'Réinitialiser',
    'list.display.range' => 'Résultats <b>%start%</b> à <b>%end%</b> sur <b>%count%</b>.',
    'list.display.all' => 'Affiche les <b>%count%</b> résultats.',
    'list.header.actions' => 'Actions',
    'nested.list.expand' => 'Montrer',
    'nested.list.collapse' => 'Cacher',
    'nested.list.loading' => 'Chargement en cours',
    'nested.list.success' => 'L\'élément a été déplacé avec succès.',
    'nested.list.error' => 'Impossible de déplacer l\'élément.',
    'profile.welcome' => '<b>Bienvenue</b>, %username%!</p>',
    'profile.login' => 'Connexion',
    'profile.logout' => 'Déconnexion',
    'entity_picker.placeholder' => 'Rechercher...',
    'collection.add' => 'Ajouter',
    'upload.file.add' => 'Ajouter un fichier...',
    'upload.error' => 'Erreur',
    'upload.cancel' => 'Enlever',
    'upload.delete' => 'Effacer',
    'upload.download' => 'Télécharger',
    'upload.errors.maxNumFiles' => 'Nombre maximum de fichiers dépassé.',
    'upload.errors.typeNotAllowed' => 'Type de fichier non autorisé.',
    'upload.errors.maxFileSize' => 'Le fichier est trop gros.',
    'upload.errors.minFileSize' => 'Le fichier est trop petite.',
    'action.generic.list' => 'Retour à la liste',
    'action.generic.new' => 'Nouveau',
    'action.generic.save' => 'Enregistrer',
    'action.generic.save-and-add' => 'Enregistrer et Nouveau',
    'action.generic.save-and-list' => 'Enregistrer et Retour à la liste',
    'action.object.edit.label' => 'Éditer',
    'action.object.edit.success' => 'L\'enregistrement a été effectué avec succès.',
    'action.object.edit.error' => 'Le formulaire n\'a pas pu être sauvegardé. Vérifiez les erreurs et essayez de soumettre à nouveau.',
    'action.object.delete.label' => 'Effacer',
    'action.object.delete.confirm' => 'Etes-vous sur de vouloir supprimer cet élement?',
    'action.object.show.label' => 'Montrer',
    'action.batch.delete.label' => 'Effacer',
    'action.batch.delete.confirm' => 'Etes-vous sur de vouloir supprimer les élements sélectionnés?',
    'action.batch.delete.success' => 'Les enregistrements ont étés supprimés avec succès.',
    'action.batch.delete.error' => 'Les enregistrements n\'ont pu être supprimés.',
    'batch.list.selected' => 'Choisir',
    'batch.list.none.selected' => 'Vous devez sélectionner au moins un élément.',
    'dashboard.homepage' => 'Accueil',
    'dashboard.brand' => 'Tableau de bord',
    'filetype.audio' => 'Audio',
    'filetype.archive' => 'Archive',
    'filetype.html' => 'HTML',
    'filetype.image' => 'Image',
    'filetype.pdf-document' => 'Document<br />PDF',
    'filetype.plain-text' => 'Texte<br />brut',
    'filetype.presentation' => 'Présentation',
    'filetype.spreadsheet' => 'Feuille<br />de calcul',
    'filetype.text-document' => 'Document<br />texte',
    'filetype.unknown' => 'Type de fichier<br />inconnu',
